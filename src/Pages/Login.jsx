...
import { FaRegArrowAltCircleRight, FaUserLock } from 'react-icons/fa';
            ...
            <div className="w-full max-w-4xl bg-white rounded-xl shadow-lg overflow-hidden grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="p-8">
                    ...
                    <form className="space-y-4">
                        ...
                        <button type="button" className="w-full flex items-center justify-center gap-3 py-3 rounded-lg border-2 border-gray-200 hover:shadow-sm transition"
                        >
                            <span> <FcGoogle /> </span>
